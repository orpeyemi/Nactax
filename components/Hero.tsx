...
const Hero: React.FC = () => {
  return (
    <section className="relative w-full h-[500px] md:h-[600px] flex items-center bg-gray-100 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 pt-20">
            <div className="max-w-xl">
                ...
                <div className="flex flex-wrap gap-4">
                    <button className="bg-black text-white px-8 py-3 rounded-full font-bold uppercase text-xs md:text-sm tracking-wide hover:bg-gray-800 transition-colors">
                        Our Products &gt;
                    </button>
                    <button className="border-2 border-nactax-red text-nactax-red px-8 py-3 rounded-full font-bold uppercase text-xs md:text-sm tracking-wide hover:bg-nactax-red hover:text-white transition-colors">
                        Get Quote Now &gt;
                    </button>
                </div>
