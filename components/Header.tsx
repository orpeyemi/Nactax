      ...
      <div className="bg-white shadow-sm py-4 sticky top-0 z-50">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-6 font-semibold text-gray-700 text-sm uppercase items-center">
            <a href="#" className="hover:text-nactax-red">Home</a>
            <a href="#about" className="hover:text-nactax-red">About</a>
            <div className="relative group">
              <button className="hover:text-nactax-red flex items-center gap-1">
            ...
            <a href="#contact" className="hover:text-nactax-red">Contact Us</a>
          </nav>
      ...
      {isMenuOpen && (
        <div className="md:hidden fixed inset-0 bg-black bg-opacity-50 z-40" onClick={() => setIsMenuOpen(false)}>
          ...
          >
            ...
            <a href="#" className="py-2 border-b border-gray-100" onClick={() => setIsMenuOpen(false)}>Home</a>
            <a href="#about" className="py-2 border-b border-gray-100" onClick={() => setIsMenuOpen(false)}>About</a>
            ...
            <div>
              ...
              {isServicesOpen && (
                <div className="pl-4 flex flex-col text-gray-600">
                  <a href="#" className="py-2 border-b border-gray-50">Business</a>
                  <a href="#" className="py-2 border-b border-gray-50">Personal Finance</a>
                  <a href="#" className="py-2 border-b border-gray-50">Other Services</a>
                </div>
              )}
            </div>
            ...
            <a href="#contact" className="py-2 border-b border-gray-100" onClick={() => setIsMenuOpen(false)}>Contact Us</a>
          </div>
        </div>
      )}
    </header>
